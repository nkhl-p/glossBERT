...
from modeling import BertForSequenceClassification, BertConfig, BartForSequenceClassification
from tokenization import BertTokenizer, BartTokenizer
...
def main():
    ...
    parser.add_argument("--bart_model", default=None, type=str, required=True,
    ...
    model = BartForSequenceClassification.from_pretrained(args.bert_model,
              cache_dir=cache_dir,
