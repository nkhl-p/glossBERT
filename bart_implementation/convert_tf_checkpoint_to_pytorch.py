...
import numpy as np
import sys
# sys.path.append("/Users/nikhil/uncased_L-12_H-768_A-12")
...
def convert_tf_checkpoint_to_pytorch(checkpoint_path, hf_checkpoint_name=None, pytorch_dump_folder_path):
    """
    Copy/paste/tweak model's weights to our BERT structure.
    """
    if not os.path.exists(checkpoint_path):
