...
def generate_auxiliary_sent_cls(gold_key_file_name, train_file_name, train_file_final_name):
...
def generate_auxiliary_sent_cls_ws(gold_key_file_name, train_file_name, train_file_final_name):
    sense_data = pd.read_csv("./wordnet/index.sense.gloss", sep="\t", header=None).values
    print(len(sense_data))
    print(sense_data[1])
...
if __name__ == "__main__":
    eval_dataset = ['senseval2', 'senseval3', 'semeval2007', 'semeval2013', 'semeval2015']
    ...
    for file_name in file_path:
        ...
        if file_name == './dataset/SemCor/semcor':
        ...
        generate_auxiliary_sent_cls(gold_key_file_name, train_file_name, train_file_final_name_sent)
        generate_auxiliary_sent_cls_ws(gold_key_file_name, train_file_name, train_file_final_name_sent_ws)
        generate_auxiliary_token_cls(gold_key_file_name, train_file_name, train_file_final_name_token)
